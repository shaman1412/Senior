...
public class PromotionMapsActivity extends AppCompatActivity implements GoogleMap.OnMyLocationButtonClickListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_promotion__maps);
        ...
        if(args != null){
            getlocation  = args.getString(Promotion.Column.Location);
            promotionName = args.getString(Promotion.Column.Title,null);
        }
    }
    ...
    public void onLocationChanged(Location location) {
        Toast.makeText(PromotionMapsActivity.this, "Location was changed", Toast.LENGTH_SHORT).show();
