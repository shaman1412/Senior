...
public class ListPartyMember extends RecyclerView.Adapter<ListPartyMember.ViewHolder> {
    ...
    public ListPartyMember(ArrayList<UserProfile> list, Context context, String key, boolean host) {
        this.list = list;
    ...
    @Override
    public ListPartyMember.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
