...
import com.Senior.Faff.Chat.ChatParty;
...
public class ShowPartyProfile extends AppCompatActivity implements OnMapReadyCallback {
        ...
        if (send_location == null) {
            mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
                ...
                public void onMapClick(LatLng latLng) {
                    Intent intent = new Intent(ShowPartyProfile.this, MapsActivity.class);
    ...
    public void setvalue(final Party partypro) {
        ...
        if (pic_url != null) {
            ...
            load.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                ...
                public void onSuccess(Uri uri) {
                    ...
                    try {
                        Picasso.with(mcontext).load(uri.toString()).fit().into(party_image);
                    } finally {
        ...
        ShowParty sh = new ShowParty(new ShowParty.AsyncResponse() {
            ...
            public void processFinish(String output) throws JSONException {
                ...
                if (arr_url != null) {
                    try {
                        Picasso.with(mcontext).load(arr_url[0]).fit().into(create_image);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
        ...
        try {
            if (partypro.getCreateid().equals(own_userid)) {
                ...
                PartyMemberRequest mSomeFragment = (PartyMemberRequest) getSupportFragmentManager().findFragmentByTag("request");
                ...
                PartyMemberRequest fragment_party = new PartyMemberRequest();
...
//            }
            ...
            PartyMemberAccept mSomeFragment1 = (PartyMemberAccept) getSupportFragmentManager().findFragmentByTag("accept");
            ...
            PartyMemberAccept fragment_accept = new PartyMemberAccept();
    ...
    private static class ShowParty extends AsyncTask<String, String, String> {
        ...
        public ShowPartyProfile.ShowParty.AsyncResponse delegate = null;

        public ShowParty(ShowPartyProfile.ShowParty.AsyncResponse delegate) {
    ...
    public void chatandleave() {
        enter_chat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(mcontext, ChatParty.class);
