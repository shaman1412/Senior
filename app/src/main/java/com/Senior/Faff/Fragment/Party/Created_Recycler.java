...
public class Created_Recycler extends RecyclerView.Adapter<Created_Recycler.ViewHolder>{
    ...
    public Created_Recycler(Context mcontext, ArrayList<Party> room_name, String userid) {
    ...
    @Override
    public Created_Recycler.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.activity_created__recycler, parent, false);
        Created_Recycler.ViewHolder vh = new Created_Recycler.ViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(final Created_Recycler.ViewHolder holder, final int position) {
        ...
        if (pic_url != null) {
            ...
            load.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                ...
                public void onSuccess(Uri uri) {
                    ...
                    Log.i("TEST:", " request recycler uri " + " : " + uri.toString() + " postition : "+position);
                ...
                public void onFailure(@NonNull Exception exception) {
                    ...
                    Log.i("TEST: ", " request recycler in List err " +  " : " + exception.toString());
