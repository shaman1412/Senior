...
//    private boolean host;
    ...
    public Room_Recycler(Context mcontext, ArrayList<Party> room_name, String userid) {
        ...
        Log.i("TEST:", " In initial recyclerview");
    }
        ...
        if (pic_url != null) {
            ...
            load.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                ...
                public void onSuccess(Uri uri) {
                    ...
                    Log.i("TEST:", " recycler uri " + " : " + uri.toString() + " postition : "+position);
                ...
                public void onFailure(@NonNull Exception exception) {
                    ...
                    Log.i("TEST: ", " recycler in List err " +  " : " + exception.toString());
...
//        setContentView(R.layout.activity_room__recycler);
//    }
//}
