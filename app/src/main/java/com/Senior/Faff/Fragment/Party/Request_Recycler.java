...
public class Request_Recycler extends RecyclerView.Adapter<Request_Recycler.ViewHolder>{
    ...
    public Request_Recycler(Context mcontext, ArrayList<Party> room_name, String userid) {
    ...
    @Override
    public Request_Recycler.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.activity_request__recycler, parent, false);
        Request_Recycler.ViewHolder vh = new Request_Recycler.ViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(final Request_Recycler.ViewHolder holder, final int position) {
