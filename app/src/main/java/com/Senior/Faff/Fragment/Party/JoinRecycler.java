...
public class JoinRecycler extends RecyclerView.Adapter<JoinRecycler.ViewHolder>{
    ...
    public JoinRecycler(Context mcontext, ArrayList<Party> room_name, String userid) {
    ...
    @Override
    public JoinRecycler.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.activity_join__recycler, parent, false);
        JoinRecycler.ViewHolder vh = new JoinRecycler.ViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(final JoinRecycler.ViewHolder holder, final int position) {
