...
public class RequestRecycler extends RecyclerView.Adapter<RequestRecycler.ViewHolder>{
    ...
    public RequestRecycler(Context mcontext, ArrayList<Party> room_name, String userid) {
    ...
    @Override
    public RequestRecycler.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.activity_request__recycler, parent, false);
        RequestRecycler.ViewHolder vh = new RequestRecycler.ViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(final RequestRecycler.ViewHolder holder, final int position) {
