...
public class CreatedRecycler extends RecyclerView.Adapter<CreatedRecycler.ViewHolder>{
    ...
    public CreatedRecycler(Context mcontext, ArrayList<Party> room_name, String userid) {
    ...
    @Override
    public CreatedRecycler.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.activity_created__recycler, parent, false);
        CreatedRecycler.ViewHolder vh = new CreatedRecycler.ViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(final CreatedRecycler.ViewHolder holder, final int position) {
