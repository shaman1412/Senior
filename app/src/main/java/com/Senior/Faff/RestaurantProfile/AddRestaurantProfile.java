...
public class AddRestaurantProfile extends AppCompatActivity implements OnMapReadyCallback,
    ...
    private AddRestaurantProfileRecyclerView adapter;
...
/*        if(getIntent().getStringExtra("Position") != null) {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AddRestaurantProfile.AddRestProfile add_pro = new AddRestaurantProfile.AddRestProfile();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(LatLng latLng) {
                Intent intent = new Intent(AddRestaurantProfile.this, AddMap.class);
...
//                imgByte.add(stream.toByteArray());
                ...
                adapter = new AddRestaurantProfileRecyclerView(this, bmap);
               ...
               LatLng lola =  new LatLng(Double.parseDouble(split[0]),Double.parseDouble(split[1]));
                ...
                markerOptions.icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN));
                mCurrLocationMarker = mMap.addMarker(markerOptions);
                Toast.makeText(AddRestaurantProfile.this,getlocation,Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private class AddRestProfile extends AsyncTask<Restaurant, String, String> {
        ...
        protected String doInBackground(Restaurant... params) {
            try {
                ...
                AddRestaurantProfile.AddRestProfile.this.imgPath = new Gson().fromJson(img_path_tmp, ArrayList.class);

                URL url = new URL("https://faff-1489402013619.appspot.com/res_profile/create");

                Helper hp = new Helper();
                hp.setRequest_method("POST");
                result = hp.multipartRequest(url.toString(),paras, AddRestaurantProfile.AddRestProfile.this.imgPath, "image", "image/jpeg");
