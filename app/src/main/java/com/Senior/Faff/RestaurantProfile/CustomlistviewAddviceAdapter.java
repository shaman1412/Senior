...
public class CustomlistviewAddviceAdapter extends ArrayAdapter<Restaurant> {
    Context mcontext;
    int[] res_id;
    Restaurant[] res_name;
    ...
    public CustomlistviewAddviceAdapter(Context context, int tv, Restaurant[] res_name, int[] res_id) {
