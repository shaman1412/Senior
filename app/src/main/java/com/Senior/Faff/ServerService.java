...
public class ServerService extends Service implements GoogleApiClient.ConnectionCallbacks,
    ...
    public void onLocationChanged(Location location) {
        Toast.makeText(ServerService.this, "Location was changed", Toast.LENGTH_SHORT).show();
...
/*        new Thread(
    ...
    public void onCreate() {
        ...
        thread.start();
        googleApiClient = new GoogleApiClient.Builder(ServerService.this)
                .addApi(LocationServices.API)
                .addConnectionCallbacks(ServerService.this)
                .addOnConnectionFailedListener(ServerService.this)
                .build();
...
/*        mLastLocation  = new Location("Target");
    ...
    public void send_notification(Party new_room){
        ...
        Intent resultIntent = new Intent(getApplicationContext(), ShowPartyProfile.class);
