...
public class ListTypeNodel extends RecyclerView.Adapter<ListTypeNodel.ViewHolder>{
    ...
    public ListTypeNodel(ArrayList<String> list, Context context){
        this.list = list;
    ...
    /* @Override
     ...
     @Override
     public ListType.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                    int viewType) {
         // create a new view
