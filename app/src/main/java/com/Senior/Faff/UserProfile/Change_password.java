            ...
            public void onClick(View v) {
                ...
                if (old != null && pass != null && compass != null) {
                    if (pass.equals(compass)) {
                        ...
                        Toast.makeText(Change_password.this, "new password and confirm password are not match", Toast.LENGTH_SHORT).show();
                    }

                } else {
                    Toast.makeText(Change_password.this, "Please  complete all field", Toast.LENGTH_SHORT).show();
                }
            }
        });
